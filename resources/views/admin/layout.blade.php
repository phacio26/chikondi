    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" class="sidebar w-64 bg-accent text-white flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('admin.team.index') }}" class="sidebar-link {{ request()->routeIs('admin.team*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-xl text-white/70 text-xs font-bold uppercase tracking-widest">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-3.13a4 4 0 100-8 4 4 0 000 8zm6 3c1.657 0 3 1.343 3 3v2h-6v-2c0-1.657 1.343-3 3-3zM7 13c1.657 0 3 1.343 3 3v2H4v-2c0-1.657 1.343-3 3-3z"/>
                    </svg>
                    Team
                </a>
                <a href="{{ route('admin.about.index') }}" class="sidebar-link {{ request()->routeIs('admin.about*') ? 'active' : '' }} flex items-center gap-3 px-3 py-2 rounded-xl text-white/70 text-xs font-bold uppercase tracking-widest">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
