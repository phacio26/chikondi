            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div>
                    ...
                    @if(SiteSetting::get('hero_image'))
                        <img src="{{ SiteSetting::get('hero_image') }}" alt="Current Hero" class="h-16 w-auto mb-4 rounded-xl object-cover">
                    @else
                ...
                <div>
                    ...
                    @if(SiteSetting::get('mother_child_image'))
                        <img src="{{ SiteSetting::get('mother_child_image') }}" alt="Current Mother & Child" class="h-16 w-auto mb-4 rounded-xl object-cover">
                    @else
